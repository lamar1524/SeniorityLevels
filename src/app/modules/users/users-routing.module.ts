...
import { CommentsComponent, UsersListComponent, UserComponent, UserProfileComponent } from './components';
...
const routes: Routes = [
  ...
  { path: `${ROUTES.comments.path}/:userId/:category`, component: CommentsComponent, canActivate: [AuthorizationGuard] },
];
